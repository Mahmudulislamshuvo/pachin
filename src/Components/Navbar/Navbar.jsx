...
const Navbar = ({ scrollToSection, refs }) => {
  ...
  const handleNavClick = (ref) => {
    scrollToSection(ref);
    setIsOpen(false); // mobile menu off
  };

  return (
    <div className="bg-[linear-gradient(65deg,theme(colors.text.White)_35%,theme(colors.background)_30%)] max-sm:bg-[linear-gradient(65deg,theme(colors.text.White)_65%,theme(colors.background)_30%)] max-md:bg-[linear-gradient(65deg,theme(colors.text.White)_70%,theme(colors.background)_30%)] py-2 md:py-4 max-sm:px-5 shadow-card2">
