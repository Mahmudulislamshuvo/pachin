import image1 from "../../assets/Images/KeyArchi1.png";
import image2 from "../../assets/Images/KeyArchi2.png";
  ...
  return (
    <div className="bg-white text-gray-800 p-8 md:p-12 font-sans min-h-screen flex items-center justify-center">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-6 lg:space-y-8 max-w-md mx-auto">
          <div className="rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
            <img
              src={image1} // Replace with your first image path
          ...
          <div className="rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
            <img
              src={image2} // Replace with your second image path
